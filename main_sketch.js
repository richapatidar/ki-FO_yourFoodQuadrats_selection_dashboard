...
title = createP("Ingredient:");
  ...
  title.position(w * 0.8,460);
  title.style("font-family", "Helvetica");
  title.style("font-size", "0.8rem");


  Layout1 = createImg('L1.png');
  Layout1.position(w * 0.8, 500);
  ...
  siteName.position(w * 8, 25)
siteName.style("font-family", "Helvetica");
  siteName.style("font-size", "0.9rem");
...
function homepage() {
  ...
  location.href = 'https://richapatidar.github.io/ki-FO_yourFoodQuadrats/';
}
